...
#     phone = StringField('Giá', [validators.DataRequired()])
#     address = StringField('Tên',[validators.DataRequired()])
#     matkhau = StringField('Tên',[validators.DataRequired()])
